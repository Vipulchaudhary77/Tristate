...
export function CTASection() {
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1615874959477-df969626fbf0?w=1920&q=80')] bg-cover bg-center mix-blend-multiply" />
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <h2
          className="font-[family-name:var(--font-cormorant)] text-4xl font-light text-black md:text-6xl"
          data-animate="fade-up"
        >
          Ready to Transform Your Space?
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-lg text-black/70" data-animate="fade-up">
          Schedule your complimentary consultation and discover how premium stone can elevate your
